...
MIGRATION NOTE:
The SDK query-building classes and functions have been removed.
Use `src.search_helper.run_universe_search` or build plain dict payloads for /v1/search.

Classes like EntitiesToSearch, build_batched_query, and entity lookup functions
are no longer available. See MIGRATION_PATTERNS.md for replacement patterns.
"""
...
class EntitiesToSearch:
    ...
    Use plain dicts and `src.search_helper.run_universe_search` instead.
    """
...
def build_similarity_queries(*args, **kwargs):
    """Deprecated — removed with SDK. Use search_helper or plain REST."""
    raise NotImplementedError(
        "build_similarity_queries removed with SDK. "
        "Use `src.search_helper.run_universe_search` or build plain dict payloads for /v1/search."
    )
...
def build_batched_query(*args, **kwargs):
    """Deprecated — removed with SDK. Use search_helper or plain REST."""
    raise NotImplementedError(
        "build_batched_query removed with SDK. "
        "Use `src.search_helper.run_universe_search` or build plain dict payloads for /v1/search."
    )
...
def create_date_ranges(
    ...
    """Generates a list of date range tuples based on the specified frequency.
    
    Note: AbsoluteDateRange removed with SDK. Returns tuples instead.
    """
