"""Search helpers for AI Revenue Generation Market Analysis (no SDK)."""
...
def search_ai_revenue_generation(
    sentences: list[str],
    start_date: str,
    end_date: str,
...
def search_by_any(
    ...
    **kwargs,
    ...
    """Alias for search_ai_revenue_generation."""
    return search_ai_revenue_generation(
        sentences=sentences,
        start_date=start_date,
        end_date=end_date,
        company_ids=company_ids,
