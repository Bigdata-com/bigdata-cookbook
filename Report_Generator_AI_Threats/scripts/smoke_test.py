"""Short end-to-end smoke test for Report_Generator_AI_Threats."""
...
def main() -> int:
    ...
    main_theme_proactivity = (
        "Integrating GenAI into products or forming partnerships to improve GenAI offerings"
    )
    ...
    generator = GenerateReport(
        ...
        keywords=keywords,
        main_theme_risk=main_theme_risk,
        main_theme_proactivity=main_theme_proactivity,
