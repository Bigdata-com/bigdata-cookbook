...
2. **Synthesize**
   ...
   - For fundamental summarization ensure to properly include inline attribution to the references.
   ...
   - Ensure that links to sources are present in the fundamental section.
   ...
   **The structure of your document must be:**
   ...
   - Fundamentals Perspective  
     ...
     - Make sure to keep all the inline references from the fundamental analysis.
