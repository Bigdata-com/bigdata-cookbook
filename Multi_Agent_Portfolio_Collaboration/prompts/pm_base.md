...
- **fundamental_analysis**: Access to historical and real-time market data, and advanced internet web search including filings and transcripts.
...
4. **Assemble and Pass to Memo Editor:**
   - When all sections pass, assemble a dictionary with the following keys:
     - `fundamental`: output from the Fundamental Analysis Agent. Add inline attribution in this section as coming from the bigdata_search  and bigdata_search_filings_transcripts tool.
...
- Reference properly the information sources and URLS to sources specially in the fundamental analysis.