...
from tools import bigdata_chat, bigdata_search, bigdata_search_filings_transcripts
...
def build_fundamental_agent():
    ...
    return Agent(
        ...
        tools=[bigdata_search, bigdata_search_filings_transcripts],
        #tools=[bigdata_search_filings_transcripts],
        #tools=[bigdata_chat],
        model=default_model,
