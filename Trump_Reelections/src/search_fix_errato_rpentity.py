    ...
    for result in tqdm(results, desc=f"Processing {document_type} results..."):
        for chunk in result.chunks:
            ...
            if document_type in (DocumentType.FILINGS, DocumentType.TRANSCRIPTS):
                ...
                # If reporting_entities is None, use entity names from chunk_entities
                if result.reporting_entities is None:
                    reporting_entities = [entity['key'] for entity in chunk_entities]
                else:
                    reporting_entities = result.reporting_entities
